...
def seclog_search2(TableName=WAF_ALERT_LOG_SQL_TABLE,
                    request_method=None,
                    src_host=None,
                    src_ip=None,
                    # remote_addr=None,
    ...
    query_sql = """select {search_params} from {waf_alert_log} where id>0 {conditions}""".format(
        waf_alert_log=TableName,
        conditions=conditions,
        search_params="request_method, server_port, src_ip as src_host, src_ip, category, msg as cn_msg, "
